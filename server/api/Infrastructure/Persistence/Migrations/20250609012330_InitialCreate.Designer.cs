...
namespace server.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250609012330_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Domain.Entities.PaymentMethod", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("server.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("server.Domain.Entities.PaymentMethod", "PaymentMethod")
                        .WithMany("Transactions")
