        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    Locale = table.Column<string>(type: "text", nullable: false, defaultValue: "en-US"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    RecurrenceId = table.Column<long>(type: "bigint", nullable: true),
                    CategoryId = table.Column<long>(type: "bigint", nullable: true),
                    InstallmentPlanId = table.Column<long>(type: "bigint", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionItems_InstallmentPlans_InstallmentPlanId",
                        column: x => x.InstallmentPlanId,
                        principalTable: "InstallmentPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallmentPlans_InstallmentPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recurrences_RecurrenceId",
                table: "Recurrences",
                column: "RecurrenceId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionItems_InstallmentPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionItems_TransactionItemId",
                table: "TransactionItems",
